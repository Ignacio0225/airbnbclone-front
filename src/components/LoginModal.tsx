...
// LoginModalPros를 넣어줌
export default function LoginModal({isOpen:isLoginOpen,onClose:onLoginClose}:LoginModalProps) {
    return (
        /*사용자에게 중요한 정보를 알리거나, 어떤 작업을 완료하도록 요구할 때 사용하는 팝업 창 (로그인 버튼으로 시작
            motionPreset은 이모션을 넣어줌 아래의 경우 오른쪽 방향으로 나타나고 사라짐)*/
        <Modal motionPreset={"slideInRight"} onClose={onLoginClose} isOpen={isLoginOpen}>
